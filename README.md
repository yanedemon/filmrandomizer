...
- локальные пользователи с входом по логину и паролю;
- у каждого пользователя свои фильмы и коллекции;
- добавить фильм по названию и выбрать нужный вариант, если найдено несколько совпадений;
- импортировать список фильмов из TXT-файла с названиями через запятую;
...
- добавлять один фильм в несколько коллекций;
- удалять коллекцию без удаления фильмов из библиотеки;
